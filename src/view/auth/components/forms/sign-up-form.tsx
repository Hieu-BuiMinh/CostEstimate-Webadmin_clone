...
function SignUpForm() {
	...
	const {
		...
		reset,
		formState: { errors },
	} = useForm<FormFields>({ resolver: zodResolver(SignUpFormValidation) })
		...
		>
			<section className="sign-up-section h-[93px] !py-0">
				<Image
					...
					className="h-auto"
				/>
				<p className="text-2xl font-medium uppercase text-[var(--color-surface-999)]">Sign up new account</p>
			</section>
